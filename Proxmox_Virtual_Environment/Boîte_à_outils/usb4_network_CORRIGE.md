...
Cette machine est allumée et pèse environ 70 Go  
...
On voit ici que le disque de 70 Go s'est transféré en seulement **47 s** !  
...
Sur cette capture on constate un downtime de seulement **102 ms**
...
Et ici on constate que la migration à chaud s'est faite en seulement **1 min** !  
